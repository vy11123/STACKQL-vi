# Bản dịch
- Đây là bản dịch file: [dashboards.md](https://github.com/stackql/stackql/blob/main/docs/case-studies/dashboards.md) thuộc dự án [StackQL](https://github.com/stackql/stackql).
